...
export default function About({ id }: SectionProps) {
  return (
    <section id={id} className="py-20 bg-gradient-to-b from-gray-50 to-white dark:from-gray-900 dark:to-gray-800">
          ...
          <div className="lg:w-1/2 w-full">
            <div className="relative rounded-2xl overflow-hidden shadow-2xl group">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end p-6">
                <p className="text-white text-lg font-medium">Full-stack developer based in Uganda and UAE </p>
              </div>
            </div>
          </div>
            ...
            <div className="relative">
              <div className="flex items-center justify-between mb-8">
                <div className="flex items-center">
                  ...
                  <h2  className="bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-blue-400 dark:from-blue-400 dark:to-blue-300">
                    My Story
                  </h2>
                </div>
                <div className="hidden lg:block text-primary text-6xl font-bold opacity-10">01</div>
              </div>

              {/* Content /}
              <h3 className="text-2xl font-bold mb-6 dark:text-white">
                A little bit about <span className="text-primary">Nathane</span>
              </h3>

              <div className="space-y-4 text-gray-600 dark:text-gray-300">
                <p className="text-lg leading-relaxed">
                  I&apos;m <span className="font-semibold text-dark dark:text-white">Nathane Kanyesigye</span>, a passionate full-stack developer specializing in modern web technologies like React, Next.js, and Node.js.
                </p>
              ...
              <div className="mt-8">
                <h4 className="text-xl font-semibold mb-4 dark:text-white">Technologies I work with:</h4>
                <div className="flex flex-wrap gap-3">
                  {['React', 'Next.js', 'TypeScript', 'Node.js', 'Tailwind', 'MongoDB'].map((tech) => (
                    <span
                      key={tech}
                      className="px-4 py-2 bg-white dark:bg-gray-700 rounded-full text-sm font-medium shadow-sm border border-gray-200 dark:border-gray-600"
                    >
                      {tech}
                    </span>
                  ))}
